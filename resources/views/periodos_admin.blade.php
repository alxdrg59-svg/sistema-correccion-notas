    ...
    <nav style="background-color: #5D0A28;" class="p-4 text-white shadow-xl">
        <div class="container mx-auto flex flex-wrap justify-between items-center gap-2">
            <div class="flex items-center space-x-3">
                ...
                <h1 class="font-bold text-xl uppercase tracking-wider">UTEC <span class="hidden sm:inline">— Gestionar Periodos</span></h1>
            </div>
            <div class="flex items-center space-x-3">
                <a href="/admin/dashboard" class="hover:text-red-300 transition text-sm font-medium flex items-center gap-2">
                    <i class="fas fa-arrow-left"></i> <span class="hidden sm:inline">Volver al Panel</span>
                </a>
